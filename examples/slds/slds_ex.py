...
model = SLDS(output_dim=1,state_dim=2,states=states,hyper_sample=False,expected_duration=10,learn_hmm=False,learn_lds=False,full_covariance=False,circular=True)
